        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to={ROUTES.FAQ} className="text-base text-gray-300 hover:text-white">
                  FAQs
                </Link>
              </li>
              <li>
                <Link to={ROUTES.DONOR} className="text-base text-gray-300 hover:text-white">
                  Donor Guidelines
                </Link>
              </li>
              <li>
                <Link to={ROUTES.REQUEST} className="text-base text-gray-300 hover:text-white">
                  Request Process
                </Link>
              </li>
            </ul>
